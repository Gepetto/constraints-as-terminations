...
class Runner:
    ...
    def _component(self, name: str) -> Type:
        ...
        # agent
            ...
            from cat_envs.tasks.utils.skrl.ppo import PPO, PPO_DEFAULT_CONFIG  # CaT modification
        ...
        # trainer
            ...
            from cat_envs.tasks.utils.skrl.sequential import SequentialTrainer as component  # CaT modification
