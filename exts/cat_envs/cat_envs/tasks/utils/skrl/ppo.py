...
class PPO(Agent):
    ...
    def init(self, trainer_cfg: Optional[Mapping[str, Any]] = None) -> None:
        ...
        if self.memory is not None:
            ...
            self.memory.create_tensor(name="terminated", size=1, dtype=torch.float32)  # CaT modification
    ...
    def record_transition(
        ...
        if self.write_interval > 0:
            ...
            finished_episodes = ((terminated >= 1) + truncated).nonzero(as_tuple=False)  # CaT modification 
    ...
    def _update(self, timestep: int, timesteps: int) -> None:
        ...
        def compute_gae(
            ...
            not_dones = 1 - dones  # CaT modification
        ...
        returns, advantages = compute_gae(
            ...
            dones=self.memory.get_tensor_by_name("terminated"),  # CaT modification
            values=values,
